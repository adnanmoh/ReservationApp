...
namespace Reservation_APIs.Migrations
{
    ...
    [Migration("20240506115407_ResortAndServiceTableMgt")]
    partial class ResortAndServiceTableMgt
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reservation_APIs.Models.ResortAndService", b =>
                {
                    b.Property<int>("ResortId")
                        .HasColumnType("int")
                        .HasColumnName("ResortID");
            ...
            modelBuilder.Entity("Reservation_APIs.Models.ResortAndService", b =>
                {
                    b.HasOne("Reservation_APIs.Models.Resort", "Resorts")
                        .WithMany("ResortAndServices")
                        .HasForeignKey("ResortId")
                        .IsRequired()
                        .HasConstraintName("FK_ResortAndService_Resort");

                    b.HasOne("Reservation_APIs.Models.ResortService", "Services")
                        .WithMany("ResortAndServices")
            ...
            modelBuilder.Entity("Reservation_APIs.Models.Resort", b =>
                {
                    ...
                    b.Navigation("ResortAndServices");
